...
class BuzzyPage4 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    double h = 650;
    String step1Msg = '''When measuring, it emits green
light and penetrates the skin. The
human blood is red and will absorb
green light. When the heart beats,
the blood flow increases, and the
amount of green light absorption
increases, and vice versa. Thereby,
the heart rate is measured based on
the blood absorbance.''';
    String step2Msg = '''Use low-frequency current to control
the user’s muscle expansion and
transform the partner’s emotions
