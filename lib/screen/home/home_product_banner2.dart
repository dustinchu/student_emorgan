...
class HomeProductBanner2 extends StatefulWidget {
  HomeProductBanner2(
      {Key key,
      this.status,
      this.id,
  ...
  final bool status;
  @override
  _HomeProductBanner2State createState() => _HomeProductBanner2State();
}

bool learnStatus = false;
bool orderStatus = false;

class _HomeProductBanner2State extends State<HomeProductBanner2>
